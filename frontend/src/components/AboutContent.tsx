...
const AboutContent = ({ h, s, v, t, coreValues, timelineItems }: AboutContentProps) => {
  ...
  return (
    <div ref={container}>
      ...
      <section className="about-hero relative min-h-[60vh] md:min-h-[70vh] flex items-end overflow-hidden bg-[#1b3b2f]">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#1b3b2f] via-[#1b3b2f]/60 to-[#1b3b2f]/20" />
        </div>

        <div className="about-hero-content relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 pb-16 md:pb-24">
          <div className="flex items-center gap-3 mb-6">
            <div className="h-px w-10 bg-[#fbbf24]" />
            <span className="text-[10px] font-bold tracking-[0.4em] text-[#fbbf24] uppercase">About Ladang Lima</span>
          </div>
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif text-white leading-[0.95] tracking-tight max-w-4xl">
            {h.title || "About Us"}
          </h1>
      ...
      <section className="about-story py-24 md:py-40">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="story-label flex items-center gap-4 mb-16 md:mb-24">
            <span className="text-[10px] font-bold tracking-[0.4em] text-[#6b9b7e] uppercase">{s.label || "Our Story"}</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            <div className="story-image-wrap lg:col-span-5 lg:mt-16">
              <div className="relative">
                <div className="absolute -top-4 -left-4 w-full h-full border border-[#6b9b7e]/20 rounded-sm" />
                ...
                <p className="mt-4 text-[10px] font-semibold tracking-[0.2em] text-forest/40 uppercase">
            ...
            <div className="story-text lg:col-span-7 space-y-8">
              <h2 className="text-4xl md:text-6xl font-serif text-forest leading-[1.05] tracking-tight">
                {s.title_line1 || "From Traditional Roots to"}{" "}
                <span className="italic text-[#6b9b7e]">{s.title_line2 || "Modern Wellness"}</span>
              </h2>

              <div className="w-12 h-px bg-[#6b9b7e]" />

              <p className="text-forest/70 text-lg md:text-xl leading-[1.7] font-light">
              ...
              <p className="text-forest/50 text-base md:text-lg leading-[1.8] font-light">
      ...
      <section className="about-values py-24 md:py-32 bg-[#1b3b2f] relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none select-none opacity-[0.03]">
          <p className="text-[300px] font-serif text-white leading-none">4P</p>
        </div>

        <div className="relative max-w-7xl mx-auto px-6 md:px-12">
          <div className="values-header mb-16 md:mb-20">
            <div className="flex items-center gap-4 mb-16 md:mb-20">
              <span className="text-[10px] font-bold tracking-[0.4em] text-[#fbbf24] uppercase">{v.label || "What We Stand For"}</span>
              <div className="flex-1 h-px bg-white/10" />
            </div>

            <h2 className="text-4xl md:text-6xl font-serif text-white leading-[1.05] tracking-tight max-w-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/10">
            {coreValues.map((value: any, i: number) => (
              <div
                key={i}
                className="value-card group bg-[#1b3b2f] p-10 md:p-14 hover:bg-[#2a5340] transition-colors duration-700"
              >
                <div className="flex items-start gap-6">
                  <span className="text-5xl md:text-6xl font-serif text-[#6b9b7e]/40 group-hover:text-[#fbbf24] transition-colors duration-700 leading-none">
                    {value.num}
                  </span>
                  <div className="space-y-4 pt-2">
                    ...
                    <div className="w-8 h-px bg-[#6b9b7e] group-hover:bg-[#fbbf24] transition-colors duration-700" />
                    <p className="text-white/50 text-sm md:text-base leading-[1.7] font-light max-w-sm">
                      {value.description}
                    </p>
                  </div>
                </div>
      ...
      <section className="about-timeline py-24 md:py-40 bg-[#FAF9F6]">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="timeline-header mb-16 md:mb-20">
            <div className="flex items-center gap-4 mb-16 md:mb-20">
              <span className="text-[10px] font-bold tracking-[0.4em] text-[#6b9b7e] uppercase">{t.label || "Our Journey"}</span>
              <div className="flex-1 h-px bg-forest/10" />
            </div>

            <h2 className="text-4xl md:text-6xl font-serif text-forest leading-[1.05] tracking-tight max-w-3xl">
              {t.title || "Milestones"}
            </h2>
          </div>
          ...
          <div className="space-y-0">
            {timelineItems.map((item: any, i: number) => (
              <div
                key={i}
                className="timeline-row group grid grid-cols-12 gap-4 md:gap-8 py-10 md:py-12 border-t border-forest/10 hover:bg-white/50 transition-colors duration-500 px-2 md:px-4"
              >
                <div className="col-span-3 md:col-span-2">
                  <span className="text-3xl md:text-5xl font-serif text-forest/30 group-hover:text-[#6b9b7e] transition-colors duration-500 leading-none">
                    {item.year}
                  </span>
                </div>
      ...
      <section className="about-closing py-24 md:py-40 bg-white">
        <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
          <div className="flex items-center justify-center gap-4 mb-12">
            <div className="h-px w-12 bg-[#6b9b7e]/30" />
            <span className="text-[10px] font-bold tracking-[0.4em] text-[#6b9b7e] uppercase">Our Promise</span>
            <div className="h-px w-12 bg-[#6b9b7e]/30" />
          </div>
          <p className="text-3xl md:text-5xl font-serif italic text-forest leading-[1.3] tracking-tight">
            Feeding the future with nature's wisdom — one harvest at a time.
          </p>
          <div className="mt-12 flex items-center justify-center gap-3">
            <div className="h-px w-8 bg-[#fbbf24]" />
            <span className="text-sm font-bold tracking-[0.3em] text-forest/40 uppercase">Ladang Lima</span>
            <div className="h-px w-8 bg-[#fbbf24]" />
          </div>
        </div>
      </section>

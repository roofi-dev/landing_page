        ...
        $sections = [
            ...
            [
                ...
                'content' => [
                    ...
                    'values' => [
                        ['icon' => 'zap', 'title' => 'Produktif', 'subtitle' => 'Productive', 'description' => 'Selalu menghasilkan karya, kinerja, atau solusi yang bernilai tinggi dan berdampak.'],
                        ['icon' => 'compass', 'title' => 'Proaktif', 'subtitle' => 'Proactive', 'description' => 'Bertindak sebelum masalah terjadi dan selalu berinisiatif.'],
                        ['icon' => 'shield-check', 'title' => 'Profesional', 'subtitle' => 'Professional', 'description' => 'Bekerja dengan kompetensi, tanggung jawab, dan standar etika tinggi.'],
                        ['icon' => 'trending-up', 'title' => 'Progresif', 'subtitle' => 'Progressive', 'description' => 'Terus berkembang, berinovasi, dan berorientasi ke depan.'],
                    ],
                ],
                'status' => 'published',
            ],

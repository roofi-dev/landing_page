        ...
        $sections = [
            ...
            [
                ...
                'content' => [
                    ...
                    'values' => [
                        ['icon' => 'zap', 'title' => 'Productive', 'description' => 'Consistently producing work, performance, and solutions of high value and meaningful impact.'],
                        ['icon' => 'compass', 'title' => 'Proactive', 'description' => 'Taking action before problems arise and always showing initiative.'],
                        ['icon' => 'shield-check', 'title' => 'Professional', 'description' => 'Working with competence, responsibility, and high ethical standards.'],
                        ['icon' => 'trending-up', 'title' => 'Progressive', 'description' => 'Continuously growing, innovating, and staying forward-oriented.'],
                    ],
                ],
                'status' => 'published',
            ],
